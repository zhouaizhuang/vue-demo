<template>
  <div :class="['fixed l0 t0 bgf bdc ovya h100vh borderBox p0', isShow ? 'zx1000' : 'zx-1 clip0']" :style="{width: A4Width + 'px', transform: isShow ? '' : 'translate(-10000px)'}">
    <!--第一页-->
    <div ref="hainan1" class="w100 ovh bdc" :style="{height: A4Height + 'px'}">
    ...
    <!--第二页-->
    <div ref="hainan2" class="w100 ovh bdc" :style="{height: A4Height + 'px'}">
      第二页
      <div class="pl20 pr20">
        <div class="bdc rds10 pt10 pb10 pl20" style="border:2px solid #000;border-radius: 10px 0 10px 0;">123</div>
        <div class="f ac xb pt20 pb20">
    ...
    <!--第三页-->
    <div ref="hainan3" class="w100 ovh bdc" :style="{height: A4Height + 'px'}">
      第三页
    </div>
  </div>
</template>
