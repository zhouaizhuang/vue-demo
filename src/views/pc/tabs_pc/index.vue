<template>
  <div style="background:#222" class="mh100vh ovh">
    <div class="auto mt60" style="background:#fff;width:60%;">
      ...
      <div class="ovh rel" style="height:630px;"> <!--高度必须限制（可以是固定值或者给定上下限-----width:clamp(200px, 50vh, 600px)）-->
        <div :class="['trans3 abs t0 l0 r0 b0 bgf pt10 pr10 pl0 fs14', tabIndex == 0 ? 'tx0' : tabIndex < 0 ? 'tx100' : 'tx-100']">
          我是标签1的内容
        </div>
        <div :class="['trans3 abs t0 l0 r0 b0 bgf pt10 pr10 pl0 fs14', tabIndex == 1 ? 'tx0' : tabIndex < 1 ? 'tx100' : 'tx-100']">
          我是标签2的内容
        </div>
      </div>
      <!--Tabs组件结束位置-->
