  ...
  <div class="w90 db auto indexFontSize">
    ...
    <div class="f">
      <div class="pr20r b" style="width:2.2rem;">CSS3动画:</div>
        <div class="f1 f xs ac rw">
          ...
          <div class="db w20 pb30 min190px"><router-link class="g42b983" to="/specialBorder">特殊边框</router-link></div>
    ...
    <div class="f">
      ...
      <div class="f1 f xs ac rw">
        ...
        <div class="db w20 pb30 min190px g42b983 tdu poi" @click="$router.push({ name: 'query1', query: {id: 123}})">params路由传参</div>
      </div>
    </div>
    <div class="f">
      <div class="pr20r b" style="width:2.2rem;">vue动画:</div>
      <div class="f1 f xs ac rw">
        <div class="db w20 pb30 min190px"><router-link class="g42b983" to="/vueAni">vue动画</router-link></div>
      </div>
    </div>
  </div>
</template>
