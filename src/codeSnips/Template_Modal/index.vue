<template>
  <div class="mh100vh ovh bg0" @click="isShowModal=true">
    <!--Modal组件起始位置-->
    <div :class="['fixed trbl0 trans3', isShowModal ? 'op10 zx10' : 'op0 zx-1']" style="background:rgba(55,55,55,.6)">
      <div :class="['fixed bgf tx-50 l50 t15 rds5 trans5', isShowModal ? 'op10 zx20 ani-large' : 'op0 zx-1 ani-small']" style="width:600px;">
        ...
        <div class="f ac xe pt10 pl10 pr15 pb10" style="border-top:1px solid #eee;">
          <div @click.stop="isShowModal=false" class="btn-hover mr20 rds4 f ac xc fs14 lt2 poi trans3" style="height:32px;width:60px;border:1px solid #dcdee2;">取消</div>
          <div class="primary rds4 f ac xc fs14 lt2 poi trans3 gf" style="height:32px;width:60px;border:1px solid #57a3f3;background:#2d8cf0;">确定</div>
        </div>
      </div>
    </div>
    <!--Modal组件结束位置-->
